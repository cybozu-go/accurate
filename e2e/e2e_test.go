...
var _ = Describe("kubectl innu", func() {
	It("should configure namespaces", func() {
		...
		_, err := kubectl(nil, "innu", "template", "set", "root1", "tmpl1")
		Expect(err).To(HaveOccurred())
		kubectlSafe(nil, "innu", "ns", "set-type", "tmpl1", "template")
		kubectlSafe(nil, "innu", "ns", "set-type", "tmpl1", "root")
		_, err = kubectl(nil, "innu", "template", "set", "root1", "tmpl1")
		Expect(err).To(HaveOccurred())
		kubectlSafe(nil, "innu", "ns", "set-type", "tmpl1", "none")
		kubectlSafe(nil, "innu", "ns", "set-type", "tmpl1", "template")
		kubectlSafe(nil, "innu", "template", "set", "root1", "tmpl1")
		...
		_, err = kubectl(nil, "innu", "ns", "set-type", "tmpl1", "none")
		Expect(err).To(HaveOccurred())
		kubectlSafe(nil, "innu", "ns", "set-type", "root1", "root")
	})
	...
	It("should propagate resources", func() {
		...
		kubectlSafe(nil, "innu", "ns", "set-type", "tmpl2", "template")
		kubectlSafe(nil, "create", "ns", "tmpl3")
		kubectlSafe(nil, "innu", "ns", "set-type", "tmpl3", "template")
		...
		kubectlSafe(nil, "innu", "template", "set", "tmpl3", "tmpl2")
		kubectlSafe(nil, "innu", "template", "set", "root2", "tmpl3")

		By("checking propagation from templates")
		kubectlSafe(nil, "annotate", "-n", "tmpl3", "secret", "s1", "innu.cybozu.com/propagate=update")
		...
		kubectlSafe(nil, "innu", "template", "unset", "root2")
		...
		_, err := kubectl(nil, "innu", "sub", "create", "foo", "root2")
		Expect(err).To(HaveOccurred())
		kubectlSafe(nil, "innu", "ns", "set-type", "root2", "root")
		kubectlSafe(nil, "innu", "ns", "set-type", "root3", "root")
		kubectlSafe(nil, "innu", "sub", "create", "sub1", "root2")
	...
	It("should handle sub-namespaces", func() {
		...
		kubectlSafe(nil, "innu", "ns", "set-type", "subroot1", "root")
		kubectlSafe(nil, "create", "ns", "subroot2")
		kubectlSafe(nil, "innu", "ns", "set-type", "subroot2", "root")

		By("creating sub-namespaces")
		kubectlSafe(nil, "innu", "sub", "create", "sn1", "subroot1")
		...
		kubectlSafe(nil, "innu", "sub", "create", "sn2", "sn1")
		...
		_, err := kubectl(nil, "innu", "sub", "move", "sn1", "sn2")
		Expect(err).To(HaveOccurred())

		kubectlSafe(nil, "innu", "sub", "move", "sn1", "subroot2")
		...
		kubectlSafe(nil, "innu", "sub", "move", "--leave-original", "sn1", "subroot1")
		kubectlSafe(nil, "get", "subnamespaces", "-n", "subroot2", "sn1")
		kubectlSafe(nil, "get", "subnamespaces", "-n", "subroot1", "sn1")
		...
		kubectlSafe(nil, "innu", "sub", "cut", "sn2")
		...
		kubectlSafe(nil, "innu", "sub", "graft", "sn2", "subroot2")
		out, err = kubectl(nil, "get", "ns", "sn2", "-o", "json")
		Expect(err).NotTo(HaveOccurred())
		sn2 = &corev1.Namespace{}
		err = json.Unmarshal(out, sn2)
		...
		kubectlSafe(nil, "innu", "sub", "delete", "sn2")
		Eventually(func() error {
	...
	It("should run other commands", func() {
		kubectlSafe(nil, "innu", "list")
		kubectlSafe(nil, "innu", "ns", "describe", "tmpl1")
	})
})
