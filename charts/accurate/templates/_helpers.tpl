...
{{ include "accurate.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "accurate.selectorLabels" -}}
...
*/}}
{{- define "accurate.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "accurate.fullname" .) .Values.serviceAccount.name }}
{{- else }}
