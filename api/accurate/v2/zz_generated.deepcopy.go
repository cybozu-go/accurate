...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubNamespaceMoveSpec) DeepCopyInto(out *SubNamespaceMoveSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubNamespaceMoveSpec.
func (in *SubNamespaceMoveSpec) DeepCopy() *SubNamespaceMoveSpec {
	if in == nil {
		return nil
	}
	out := new(SubNamespaceMoveSpec)
	in.DeepCopyInto(out)
	return out
}
